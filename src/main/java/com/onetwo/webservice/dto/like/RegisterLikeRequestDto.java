...
@Getter
public class RegisterLikeRequestDto extends AccessTokenDto {
    ...
    public RegisterLikeRequestDto(@NotEmpty String accessToken, Integer category, Long targetId) {
        super(accessToken);
    ...
    public boolean equals(Object o) {
        ...
        RegisterLikeRequestDto that = (RegisterLikeRequestDto) o;
